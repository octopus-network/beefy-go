module github.com/octopus-network/beefy-go

go 1.18

require github.com/btcsuite/btcd v0.22.3 // indirect
...
require (
	...
	github.com/octopus-network/grandpa-go v0.0.0-20230119112643-22c88d769a96
